...
def coat_material():
    ...
    for s0, tilt, phase, emb in G.LINE_LOOPS:
        ...
        g = b.mr(b.add(dsl, b.mul(b.math('SUBTRACT', b.noise(P, 140.0, 3), 0.5), 0.003)), 0.0042, 0.0)
    ...
    sick = b.mix(b.mul(raw_edge, 0.7), sick, (0.13, 0.03, 0.03))
    sick = b.mix(raw, sick, b.mix(b.noise(P, 300.0, 3), (0.12, 0.006, 0.008), (0.26, 0.03, 0.03)))

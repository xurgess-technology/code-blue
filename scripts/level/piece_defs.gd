...
const P := {
	...
	"gurney": {"size": Vector3(0.75, 0.9, 2.0), "block": true, "anchors": [[Vector3(0.0, 0.83, 0.45), "gurney"]]},
	"gurney_body": {"size": Vector3(0.75, 1.1, 2.0), "block": true},
	"instrument_cart": {"size": Vector3(1.27, 0.96, 0.75), "block": true, "anchors": [[Vector3(-0.3, 0.96, 0.0), "tray"]]},
	# ---- janitor ------------------------------------------------------------

...
const P := {
	# ---- patient rooms ----------------------------------------------------
	"hospital_bed": {"size": Vector3(1.0, 0.95, 2.15), "block": true},
	"bed_tray": {"size": Vector3(0.8, 1.0, 0.45), "anchors": [[Vector3(0.12, 1.0, 0.0), "tray"]]},
	"curtain": {"size": Vector3(1.9, 2.45, 0.12), "collide": false},
	"iv_stand": {"size": Vector3(0.45, 1.95, 0.45)},
	"bedside": {"size": Vector3(0.8, 0.58, 0.34), "anchors": [[Vector3(0.18, 0.58, 0.0), "tray"]]},
	...
	"magazine_table": {"size": Vector3(1.19, 0.41, 0.72), "anchors": [[Vector3(0.2, 0.41, 0.0), "counter"]]},
	...
	"vending": {"size": Vector3(0.81, 1.97, 0.87)},
	"med_cart": {"size": Vector3(0.7, 1.05, 0.5)},
	"computer": {"size": Vector3(0.6, 0.5, 0.25), "collide": false},
	"wheelchair": {"size": Vector3(0.82, 1.1, 1.09)},
	# ---- restrooms --------------------------------------------------------
	...
	"console_desk": {"size": Vector3(1.8, 1.1, 0.8), "block": true, "anchors": [[Vector3(0.6, 0.76, 0.05), "counter"]]},
	...
	"gurney": {"size": Vector3(0.75, 0.9, 2.0), "anchors": [[Vector3(0.0, 0.83, 0.45), "gurney"]]},
	"gurney_body": {"size": Vector3(0.75, 1.1, 2.0)},
	"instrument_cart": {"size": Vector3(1.27, 0.96, 0.75), "anchors": [[Vector3(-0.3, 0.96, 0.0), "tray"]]},
	# ---- janitor ------------------------------------------------------------
	...
	# ---- cafeteria ------------------------------------------------------------
	"cafeteria_table": {"size": Vector3(1.94, 0.75, 1.03), "block": true},
	"tray": {"size": Vector3(0.45, 0.03, 0.33), "collide": false, "anchors": [[Vector3(0.0, 0.03, 0.0), "tray"]]},
	"serving_counter": {"size": Vector3(1.5, 1.35, 0.8), "block": true, "anchors": [[Vector3(0.0, 0.92, -0.22), "counter"]]},
	"tray_stack": {"size": Vector3(0.5, 0.3, 0.4), "collide": false, "anchors": [[Vector3(0.0, 0.3, 0.0), "tray"]]},
	"register": {"size": Vector3(1.36, 0.95, 1.36), "block": true},
	# ---- break room, lockers, lobby --------------------------------------------
	"lockers": {"size": Vector3(1.5, 1.9, 0.5), "block": true},
	"bench": {"size": Vector3(1.8, 0.46, 0.42)},
	...
	# ---- operating room --------------------------------------------------------
	"or_table": {"size": Vector3(2.4, 1.0, 1.1), "block": true},
	"surgical_lamp": {"size": Vector3(0.9, 0.9, 0.9), "collide": false},
	"anesthesia_cart": {"size": Vector3(0.7, 1.6, 0.6)},
	"crash_cart": {"size": Vector3(0.8, 1.1, 0.6)},
	...
	"barrier": {"size": Vector3(1.46, 0.84, 0.5)},
	"shop_table": {"size": Vector3(1.8, 0.8, 0.75)},
	"shop_crates": {"size": Vector3(0.9, 0.9, 0.7)},
	"pallet": {"size": Vector3(1.2, 0.14, 1.0), "collide": false},
	"outdoor_bench": {"size": Vector3(1.8, 0.85, 0.6)},
}
